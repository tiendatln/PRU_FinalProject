...
public class SpawnSkillMap6 : MonoBehaviour
{
    ...
    public void Shoot()
    {
        int ran = Random.Range(-60, 60);
        GameObject fire = Instantiate(skil, this.transform.position, this.transform.rotation = Quaternion.Euler(0, 0, ran));
